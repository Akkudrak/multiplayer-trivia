...
var quesList = {
    "general": [
        ...
        ['¿Cómo se llama la religión que considera al Corán como su libro sagrado?','Catoliciscmo','El Islam','Cristianos',2],
        ...
        ['¿Cuál es la capital de México?','Guanajuato','Ciudad de Mexico','Estado de Mexico',2],
    ...
    "cine": [
        ...
        ['¿Cuál fue la primera película mexicana nominada al Oscar?', 'Macario', 'Nosotros los Pobres', 'Tizoc', 0],
        ...
        ['¿En qué película se muestra una tabla para invocar espíritus o demonios?', 'El Exorcista', 'Ouija', 'El Chavo con los espíritus chocarreros', 2],
    ...
    "arte": [
        ...
        ['¿Cuál es el libro más vendido de los últimos 50 años?', 'La Biblia', 'Harry Potter (Saga)', 'El Señor de los Anillos (Saga)', 1],
    ...
    "geografia": [
        ...
        ['¿Qué país tiene la mayor población del mundo?', 'India', 'China', 'Estados Unidos', 1],
    ...
    "matematicas": [
        ...
        ['¿Qué es falso sobre una división exacta?', 'Es falsa', 'Es verdadera', 'La división no da cero', 0],
